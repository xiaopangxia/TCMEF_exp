...
class DecisionTreeClassify():
    ...
    """
    @classmethod
    def dt_classify_core(cls, pos_vec_list, neg_vec_list_large, feature_d, log_file):
        """
        决策树分类核心部件
        :return: 
        """
    ...
    @classmethod
    def dt_classify_with_word_vec(cls, feature_d, log_file, with_name=False, merge_by='mosaic'):
        """
        利用词语向量特征做dt分类
        ...
        cls.dt_classify_core(pos_vec_list, neg_vec_list_large, feature_d, log_file)

    @classmethod
    def dt_classify_with_zi_vec(cls, feature_d, log_file, with_name=False, merge_by='mosaic'):
        """
        利用单字向量特征做dt分类
        :param feature_d: 
        :param log_file: 
    ...
    @classmethod
    def dt_classify_with_stroke_count_vec(cls, feature_d, log_file, with_name=False):
        """
        利用单字笔画数特征做dt分类
        :param feature_d: 
        :param log_file: 
    ...
    @classmethod
    def dt_classify_with_stroke_seq_vec(cls, feature_d, log_file, with_name=False):
        """
        利用单字笔画序列特征做dt分类
        :param feature_d: 
        :param log_file: 
    ...
    @classmethod
    def dt_classify_with_stroke_joint_vec(cls, feature_d, log_file, with_name=False):
        """
    ...
    @classmethod
    def dt_classify_with_zi_stroke_vec(cls, feature_d, log_file, with_name=False, merge_by='mosaic'):
        """
        联合单字向量和笔画特征做分类,
...
# DecisionTreeClassify.dt_classify_with_word_vec(feature_d=500, log_file='word_noname_mosaic')
# DecisionTreeClassify.dt_classify_with_word_vec(feature_d=500, log_file='word_name_mosaic', with_name=True)
# DecisionTreeClassify.dt_classify_with_word_vec(feature_d=50, log_file='word_noname_sum', merge_by='sum')
# DecisionTreeClassify.dt_classify_with_word_vec(feature_d=50, log_file='word_name_sum', with_name=True, merge_by='sum')


# DecisionTreeClassify.dt_classify_with_zi_vec(feature_d=1000, log_file='zi_noname_mosaic')
# DecisionTreeClassify.dt_classify_with_zi_vec(feature_d=1000, log_file='zi_name_mosaic', with_name=True)
# DecisionTreeClassify.dt_classify_with_zi_vec(feature_d=50, log_file='zi_noname_sum', merge_by='sum')
# DecisionTreeClassify.dt_classify_with_zi_vec(feature_d=50, log_file='zi_name_sum', with_name=True, merge_by='sum')



# DecisionTreeClassify.dt_classify_with_stroke_count_vec(feature_d=100, log_file='stroke_count_noname_mosaic')
# DecisionTreeClassify.dt_classify_with_stroke_count_vec(feature_d=100, log_file='stroke_count_name_mosaic', with_name=True)



# DecisionTreeClassify.dt_classify_with_stroke_seq_vec(feature_d=600, log_file='stroke_seq_noname_mosaic')
# DecisionTreeClassify.dt_classify_with_stroke_seq_vec(feature_d=600, log_file='stroke_seq_name_mosaic', with_name=True)
#

# DecisionTreeClassify.dt_classify_with_stroke_joint_vec(feature_d=700, log_file='stroke_joint_noname_mosaic')
# DecisionTreeClassify.dt_classify_with_stroke_joint_vec(feature_d=700, log_file='stroke_joint_name_mosaic', with_name=True)



# DecisionTreeClassify.dt_classify_with_zi_stroke_vec(feature_d=1700, log_file='zi_stroke_noname_mosaic')
# DecisionTreeClassify.dt_classify_with_zi_stroke_vec(feature_d=1700, log_file='zi_stroke_name_mosaic', with_name=True)
# DecisionTreeClassify.dt_classify_with_zi_stroke_vec(feature_d=750, log_file='zi_stroke_noname_sum', merge_by='sum')
# DecisionTreeClassify.dt_classify_with_zi_stroke_vec(feature_d=750, log_file='zi_stroke_name_sum', with_name=True, merge_by='sum')


# DecisionTreeClassify.dt_classify_with_zi_stroke_vec(feature_d=1700, log_file='zi_stroke_name_mosaic_special', with_name=True)
# DecisionTreeClassify.dt_classify_with_zi_stroke_vec(feature_d=750, log_file='zi_stroke_name_sum_special', with_name=True, merge_by='sum')
